...
-- BCrypt 哈希值: $2a$10$N9qo8uLOickgx2ZMRZoMye/IVI9Dqn6F6fu2WKZn7uyT2W.2Lfvbm (对应密码: 123456明文)
INSERT INTO `users` (`username`, `password`, `nickname`, `phone`, `email`, `user_type`, `balance`, `carbon_credits`, `status`) VALUES
-- 管理员账号
('admin', '$2a$10$N9qo8uLOickgx2ZMRZoMye/IVI9Dqn6F6fu2WKZn7uyT2W.2Lfvbm', '系统管理员', '13800138000', 'admin@evcharge.com', 'ADMIN', 10000.00, 0, 'ACTIVE'),
-- 普通用户账号
('zhangsan', '$2a$10$N9qo8uLOickgx2ZMRZoMye/IVI9Dqn6F6fu2WKZn7uyT2W.2Lfvbm', '张三', '13800138001', 'zhangsan@test.com', 'USER', 500.00, 1200, 'ACTIVE'),
('lisi', '$2a$10$N9qo8uLOickgx2ZMRZoMye/IVI9Dqn6F6fu2WKZn7uyT2W.2Lfvbm', '李四', '13800138002', 'lisi@test.com', 'USER', 300.00, 850, 'ACTIVE'),
('wangwu', '$2a$10$N9qo8uLOickgx2ZMRZoMye/IVI9Dqn6F6fu2WKZn7uyT2W.2Lfvbm', '王五', '13800138003', 'wangwu@test.com', 'USER', 200.00, 2100, 'ACTIVE')
ON DUPLICATE KEY UPDATE update_time = NOW();
