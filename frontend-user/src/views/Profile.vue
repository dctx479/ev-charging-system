<template>
  <div class="profile-container">
    ...
    <!-- 创新服务 -->
    <div class="menu-section">
      <van-cell-group title="创新服务">
        <van-cell title="V2G双向充电" icon="flash" is-link to="/v2g/center" />
        <van-cell title="能源监控" icon="chart-trending-o" is-link to="/energy/monitor" />
        <van-cell title="充电搭子" icon="chat-o" is-link to="/chat/buddy" />
        <van-cell title="代充服务" icon="manager-o" is-link to="/valet/service" />
        <van-cell title="代充订单" icon="logistics" is-link to="/valet/orders" />
        <van-cell title="周边服务" icon="location-o" is-link to="/nearby/service" />
      </van-cell-group>
    </div>

    <div class="menu-section">
      <van-cell-group title="账户管理">
        <van-cell title="个人信息" icon="contact-o" is-link to="/user/info" />
        <van-cell title="账户余额" icon="balance-o" is-link to="/wallet/balance">
          <template #value>
            <span>¥ {{ balance?.toFixed(2) || '0.00' }}</span>
          </template>
        </van-cell>
        <van-cell title="积分商城" icon="gift-o" is-link to="/credit/shop" />
        <van-cell title="兑换记录" icon="bill-o" is-link to="/credit/exchange/records" />
