<template>
  <div class="home-container">
    ...
    <div class="feature-grid">
      <div class="feature-item" @click="router.push('/v2g/center')">
        <van-icon name="flash" size="28" color="#1989fa" />
        <span>V2G充电</span>
      </div>
      <div class="feature-item" @click="router.push('/energy/monitor')">
        <van-icon name="chart-trending-o" size="28" color="#07c160" />
        <span>能源监控</span>
      </div>
      <div class="feature-item" @click="router.push('/chat/buddy')">
        <van-icon name="chat-o" size="28" color="#ff976a" />
        <span>充电搭子</span>
      </div>
      <div class="feature-item" @click="router.push('/valet/service')">
        <van-icon name="manager-o" size="28" color="#ee0a24" />
        <span>代充服务</span>
      </div>
      <div class="feature-item" @click="router.push('/nearby/service')">
        <van-icon name="location-o" size="28" color="#ff976a" />
        <span>周边服务</span>
      </div>
      <div class="feature-item" @click="router.push('/credit/center')">
        <van-icon name="diamond-o" size="28" color="#ffd21e" />
        <span>碳积分</span>
      </div>
    </div>
